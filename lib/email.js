...
/**
 * Resolve the technical From address. Enterprise detailers with a verified
 * custom_email_domain send through their own domain via Resend Domains.
 * Everyone else uses the platform sending domain.
 */
