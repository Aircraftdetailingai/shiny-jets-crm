const translations = {
  en: {
    ...
    footerCta: {
      ...
      sub: 'Vector is in beta. Join now and lock in Pro pricing forever as a founding member. Built by Brett Berry, President of the Aircraft Detailers Association, with 15+ years in the industry.',
      cta: 'Join as a Founding Member',
    },
    footer: {
