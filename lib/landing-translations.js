const translations = {
  en: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'For full-time detailers', cta: 'Go Pro', features: ['Unlimited quotes', '300+ aircraft database', 'Email quotes', 'Email notifications', 'Remove Vector branding', 'Calendar & scheduling', 'Priority support', '2% platform fee'] },
    ...
    footer: {
      by: 'by Vector Aviation',
      copy: '\u00A9 2026 Vector Aviation Software. All rights reserved.',
  ...
  es: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Para detalladores a tiempo completo', cta: 'Ir a Pro', features: ['Cotizaciones ilimitadas', 'Base de datos de 300+ aeronaves', 'Email cotizaciones', 'Notificaciones por email', 'Sin marca Vector', 'Calendario', 'Soporte prioritario', '2% comisi\u00F3n'] },
    ...
    footer: { by: 'por Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Todos los derechos reservados.', terms: 'T\u00E9rminos', privacy: 'Privacidad', contact: 'Contacto' },
  },
  ...
  pt: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Para detalhadores em tempo integral', cta: 'Ir para Pro', features: ['Or\u00E7amentos ilimitados', 'Banco de 300+ aeronaves', 'Email or\u00E7amentos', 'Notifica\u00E7\u00F5es por email', 'Sem marca Vector', 'Calend\u00E1rio', 'Suporte priorit\u00E1rio', '2% taxa'] },
    ...
    footer: { by: 'por Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Todos os direitos reservados.', terms: 'Termos', privacy: 'Privacidade', contact: 'Contato' },
  },
  ...
  fr: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Pour les d\u00E9tailleurs \u00E0 plein temps', cta: 'Passer Pro', features: ['Devis illimit\u00E9s', 'Base de 300+ a\u00E9ronefs', 'Devis par email', 'Notifications par email', 'Sans marque Vector', 'Calendrier', 'Support prioritaire', '2% commission'] },
    ...
    footer: { by: 'par Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Tous droits r\u00E9serv\u00E9s.', terms: 'Conditions', privacy: 'Confidentialit\u00E9', contact: 'Contact' },
  },
  ...
  de: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'F\u00FCr Vollzeit-Detailer', cta: 'Pro W\u00E4hlen', features: ['Unbegrenzte Angebote', '300+ Flugzeug-Datenbank', 'E-Mail-Angebote', 'E-Mail-Benachrichtigungen', 'Ohne Vector-Branding', 'Kalender', 'Priorit\u00E4ts-Support', '2% Plattformgeb\u00FChr'] },
    ...
    footer: { by: 'von Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Alle Rechte vorbehalten.', terms: 'AGB', privacy: 'Datenschutz', contact: 'Kontakt' },
  },
  ...
  it: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Per detailer a tempo pieno', cta: 'Vai Pro', features: ['Preventivi illimitati', 'Database 300+ aeromobili', 'Email preventivi', 'Notifiche email', 'Senza marchio Vector', 'Calendario', 'Supporto prioritario', '2% commissione'] },
    ...
    footer: { by: 'di Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Tutti i diritti riservati.', terms: 'Termini', privacy: 'Privacy', contact: 'Contatto' },
  },
  ...
  nl: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: 'Voor fulltime detailers', cta: 'Ga Pro', features: ['Onbeperkte offertes', '300+ vliegtuig database', 'E-mail offertes', 'E-mail meldingen', 'Zonder Vector branding', 'Kalender', 'Prioriteit support', '2% platformkosten'] },
    ...
    footer: { by: 'door Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. Alle rechten voorbehouden.', terms: 'Voorwaarden', privacy: 'Privacy', contact: 'Contact' },
  },
  ...
  ja: {
    ...
    footer: { by: 'by Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. All rights reserved.', terms: '\u5229\u7528\u898F\u7D04', privacy: '\u30D7\u30E9\u30A4\u30D0\u30B7\u30FC', contact: '\u304A\u554F\u3044\u5408\u308F\u305B' },
  },
  ...
  zh: {
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: '\u9002\u5408\u5168\u804C\u7F8E\u5BB9\u5E08', cta: '\u5347\u7EA7Pro', features: ['\u65E0\u9650\u62A5\u4EF7', '300+\u98DE\u673A\u6570\u636E\u5E93', '\u90AE\u4EF6\u62A5\u4EF7', '\u90AE\u4EF6\u901A\u77E5', '\u53BB\u9664Vector\u54C1\u724C', '\u65E5\u5386', '\u4F18\u5148\u652F\u6301', '2%\u5E73\u53F0\u8D39'] },
    ...
    footer: { by: 'by Vector Aviation', copy: '\u00A9 2026 Vector Aviation Software. \u4FDD\u7559\u6240\u6709\u6743\u5229\u3002', terms: '\u670D\u52A1\u6761\u6B3E', privacy: '\u9690\u79C1\u653F\u7B56', contact: '\u8054\u7CFB\u6211\u4EEC' },
  },
};
