const translations = {
  en: {
    nav: { features: 'Features', pricing: 'Pricing', faq: 'FAQ', signIn: 'Sign In', startFree: 'Start Free' },
    hero: {
      badge: 'Trusted by 100+ Aircraft Detailers',
      headline: 'The #1 CRM Built for',
      headlineHighlight: 'Aircraft Detailers',
      sub: 'Quote in 60 seconds. Get paid instantly. Grow your business.',
      cta: 'Start Free Trial',
      cta2: 'See How It Works',
      noCc: 'No credit card required. Free plan available forever.',
    },
    ...
    problems: [
      ...
      { title: '300+ Aircraft, Your Hours', desc: 'Default hours for 300+ aircraft from a Robinson R22 to a Boeing 747. Use ours, upload yours, or adjust per job.' },
    ...
    steps: [
      ...
      { title: 'Select Aircraft, Build Quote', desc: 'Choose from 300+ pre-loaded aircraft or add your own hours. Vector calculates the price \u2014 you stay in control.' },
      { title: 'Send to Client, Get Paid', desc: 'Email or text the quote. Your client views a professional branded page and pays online with one click.' },
    ],
    features: {
      ...
      items: [
        { title: '300+ Aircraft Database', desc: 'Pre-loaded hours for 300+ aircraft \u2014 or upload your own. Use our defaults as a starting point and adjust per job.' },
        ...
        { title: 'Email & SMS Delivery', desc: 'Send professional quotes directly to clients via email or text. Track when they view it.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Free', desc: 'Try Vector risk-free', cta: 'Start Free', features: ['3 quotes/month', '300+ aircraft database', 'Email quotes', 'Stripe payments', '5% platform fee'] },
        { name: 'Pro', desc: 'For full-time detailers', cta: 'Go Pro', features: ['Unlimited quotes', '300+ aircraft database', 'Email & SMS quotes', 'SMS alerts to you', 'Remove Vector branding', 'Calendar & scheduling', 'Priority support', '2% platform fee'] },
        { name: 'Business', desc: 'For teams & high-volume shops', cta: 'Get Business', features: ['Everything in Pro', 'Multi-user access', 'Vendor portal', 'API access', 'ROI analytics', 'SMS to clients', 'Dedicated support', '1% platform fee'] },
      ],
    },
    testimonials: {
      title: 'What Detailers Are Saying',
      items: [
    ...
    faqs: {
      ...
      items: [
        { q: 'How does pricing work?', a: 'Vector multiplies your hourly rate by the service hours for each aircraft. We pre-load default hours for 300+ models, but you can upload your own or adjust hours on any quote.' },
        ...
        { q: 'How accurate are the aircraft hours?', a: 'Our database covers 300+ aircraft with default hours derived from real-world detailing data. You can use the defaults, upload your own, or adjust per quote.' },
      ],
    },
    footerCta: {
      title: 'Ready to Grow Your Detailing Business?',
      sub: 'Join 100+ aircraft detailing professionals who save hours every week with Vector. Start free \u2014 no credit card required.',
      cta: 'Start Free Trial',
    },
    footer: {
      by: 'by Aircraft Detailing 101',
      copy: '\u00A9 2025 Vector Aviation Software. All rights reserved.',
  ...
  es: {
    ...
    problems: [
      ...
      { title: '300+ Aeronaves, Tus Horas', desc: 'Horas predeterminadas para 300+ aeronaves. Usa las nuestras, sube las tuyas o ajusta por trabajo.' },
    ...
    steps: [
      ...
      { title: 'Selecciona Aeronave, Crea Cotizaci\u00F3n', desc: 'Elige entre 300+ aeronaves precargadas o agrega tus propias horas. Vector calcula el precio.' },
      { title: 'Env\u00EDa al Cliente, Cobra', desc: 'Env\u00EDa la cotizaci\u00F3n por email o SMS. Tu cliente ve una p\u00E1gina profesional y paga en l\u00EDnea con un clic.' },
    ],
    features: {
      title: 'Todo lo que Necesitas para Cotizar, Reservar y Crecer',
      sub: 'Dise\u00F1ado espec\u00EDficamente para detalladores de aeronaves.',
      items: [
        { title: 'Base de Datos de 300+ Aeronaves', desc: 'Horas precargadas para 300+ aeronaves. Usa nuestros valores o sube los tuyos.' },
        { title: 'Cotizaci\u00F3n Instant\u00E1nea', desc: 'Selecciona aeronave, elige servicios, ajusta horas. Cotizaci\u00F3n precisa en 60 segundos.' },
        { title: 'Env\u00EDo por Email y SMS', desc: 'Env\u00EDa cotizaciones profesionales directamente a tus clientes. Rastrea cu\u00E1ndo las ven.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratis', desc: 'Prueba Vector sin riesgo', cta: 'Empezar Gratis', features: ['3 cotizaciones/mes', 'Base de datos de 300+ aeronaves', 'Cotizaciones por email', 'Pagos con Stripe', '5% comisi\u00F3n'] },
        { name: 'Pro', desc: 'Para detalladores a tiempo completo', cta: 'Ir a Pro', features: ['Cotizaciones ilimitadas', 'Base de datos de 300+ aeronaves', 'Email y SMS', 'Alertas SMS', 'Sin marca Vector', 'Calendario', 'Soporte prioritario', '2% comisi\u00F3n'] },
        { name: 'Business', desc: 'Para equipos y talleres', cta: 'Obtener Business', features: ['Todo en Pro', 'Acceso multiusuario', 'Portal de proveedores', 'Acceso API', 'An\u00E1lisis ROI', 'SMS a clientes', 'Soporte dedicado', '1% comisi\u00F3n'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        { q: '\u00BFC\u00F3mo funciona el precio?', a: 'Vector multiplica tu tarifa por hora por las horas de servicio de cada aeronave. Precargamos horas para 300+ modelos.' },
        ...
        { q: '\u00BFQu\u00E9 tan precisas son las horas?', a: 'Nuestra base cubre 300+ aeronaves con datos reales. Puedes usar los valores predeterminados o subir los tuyos.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'por Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Todos los derechos reservados.', terms: 'T\u00E9rminos', privacy: 'Privacidad', contact: 'Contacto' },
  },
  ...
  pt: {
    ...
    problems: [
      ...
      { title: '300+ Aeronaves, Suas Horas', desc: 'Horas padr\u00E3o para 300+ aeronaves. Use as nossas, envie as suas ou ajuste por trabalho.' },
    ...
    steps: [
      ...
      { title: 'Selecione Aeronave, Crie Or\u00E7amento', desc: 'Escolha entre 300+ aeronaves pr\u00E9-carregadas. O Vector calcula o pre\u00E7o.' },
      { title: 'Envie ao Cliente, Receba', desc: 'Envie o or\u00E7amento por email ou SMS. Seu cliente paga online com um clique.' },
    ],
    features: {
      title: 'Tudo que Voc\u00EA Precisa para Or\u00E7ar, Agendar e Crescer',
      sub: 'Feito especificamente para detalhadores de aeronaves.',
      items: [
        { title: 'Banco de Dados de 300+ Aeronaves', desc: 'Horas pr\u00E9-carregadas para 300+ aeronaves. Use nossos padr\u00F5es ou envie os seus.' },
        { title: 'Or\u00E7amento Instant\u00E2neo', desc: 'Selecione aeronave, escolha servi\u00E7os, ajuste horas. Or\u00E7amento preciso em 60 segundos.' },
        { title: 'Envio por Email e SMS', desc: 'Envie or\u00E7amentos profissionais diretamente aos clientes. Rastreie quando visualizam.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gr\u00E1tis', desc: 'Experimente sem risco', cta: 'Come\u00E7ar Gr\u00E1tis', features: ['3 or\u00E7amentos/m\u00EAs', 'Banco de 300+ aeronaves', 'Or\u00E7amentos por email', 'Pagamentos Stripe', '5% taxa'] },
        { name: 'Pro', desc: 'Para detalhadores em tempo integral', cta: 'Ir para Pro', features: ['Or\u00E7amentos ilimitados', 'Banco de 300+ aeronaves', 'Email e SMS', 'Alertas SMS', 'Sem marca Vector', 'Calend\u00E1rio', 'Suporte priorit\u00E1rio', '2% taxa'] },
        { name: 'Business', desc: 'Para equipes e oficinas', cta: 'Obter Business', features: ['Tudo no Pro', 'Acesso multiusu\u00E1rio', 'Portal de fornecedores', 'Acesso API', 'An\u00E1lise ROI', 'SMS para clientes', 'Suporte dedicado', '1% taxa'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        ...
        { q: 'Qu\u00E3o precisas s\u00E3o as horas?', a: 'Nosso banco cobre 300+ aeronaves com dados reais. Use os padr\u00F5es ou envie os seus.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'por Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Todos os direitos reservados.', terms: 'Termos', privacy: 'Privacidade', contact: 'Contato' },
  },
  ...
  fr: {
    ...
    problems: [
      ...
      { title: '300+ A\u00E9ronefs, Vos Heures', desc: 'Heures par d\u00E9faut pour 300+ a\u00E9ronefs. Utilisez les n\u00F4tres, importez les v\u00F4tres ou ajustez par travail.' },
    ...
    steps: [
      ...
      { title: 'S\u00E9lectionnez l\'A\u00E9ronef, Cr\u00E9ez le Devis', desc: 'Choisissez parmi 300+ a\u00E9ronefs pr\u00E9charg\u00E9s. Vector calcule le prix.' },
      { title: 'Envoyez au Client, Soyez Pay\u00E9', desc: 'Envoyez le devis par email ou SMS. Votre client consulte une page professionnelle et paie en ligne.' },
    ],
    features: {
      title: 'Tout Ce Dont Vous Avez Besoin',
      sub: 'Con\u00E7u sp\u00E9cifiquement pour les d\u00E9tailleurs d\'a\u00E9ronefs.',
      items: [
        { title: 'Base de 300+ A\u00E9ronefs', desc: 'Heures pr\u00E9charg\u00E9es pour 300+ a\u00E9ronefs. Utilisez nos valeurs ou importez les v\u00F4tres.' },
        { title: 'Devis Instantan\u00E9', desc: 'S\u00E9lectionnez l\'a\u00E9ronef, choisissez les services. Devis pr\u00E9cis en 60 secondes.' },
        { title: 'Envoi par Email et SMS', desc: 'Envoyez des devis professionnels directement \u00E0 vos clients.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratuit', desc: 'Essayez Vector sans risque', cta: 'Commencer', features: ['3 devis/mois', 'Base de 300+ a\u00E9ronefs', 'Devis par email', 'Paiements Stripe', '5% commission'] },
        { name: 'Pro', desc: 'Pour les d\u00E9tailleurs \u00E0 plein temps', cta: 'Passer Pro', features: ['Devis illimit\u00E9s', 'Base de 300+ a\u00E9ronefs', 'Email et SMS', 'Alertes SMS', 'Sans marque Vector', 'Calendrier', 'Support prioritaire', '2% commission'] },
        { name: 'Business', desc: 'Pour les \u00E9quipes', cta: 'Obtenir Business', features: ['Tout dans Pro', 'Acc\u00E8s multi-utilisateurs', 'Portail fournisseurs', 'Acc\u00E8s API', 'Analyses ROI', 'SMS aux clients', 'Support d\u00E9di\u00E9', '1% commission'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        ...
        { q: 'Les heures sont-elles pr\u00E9cises ?', a: 'Notre base couvre 300+ a\u00E9ronefs avec des donn\u00E9es r\u00E9elles. Vous pouvez ajuster \u00E0 tout moment.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'par Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Tous droits r\u00E9serv\u00E9s.', terms: 'Conditions', privacy: 'Confidentialit\u00E9', contact: 'Contact' },
  },
  ...
  de: {
    ...
    problems: [
      ...
      { title: '300+ Flugzeuge, Ihre Stunden', desc: 'Standardstunden f\u00FCr 300+ Flugzeuge. Nutzen Sie unsere, laden Sie Ihre hoch oder passen Sie pro Auftrag an.' },
    ...
    steps: [
      ...
      { title: 'Flugzeug W\u00E4hlen, Angebot Erstellen', desc: 'W\u00E4hlen Sie aus 300+ vorgeladenen Flugzeugen. Vector berechnet den Preis.' },
      { title: 'An Kunden Senden, Bezahlt Werden', desc: 'Senden Sie das Angebot per E-Mail oder SMS. Ihr Kunde zahlt online mit einem Klick.' },
    ],
    features: {
      title: 'Alles Was Sie Brauchen',
      sub: 'Speziell f\u00FCr Flugzeug-Detailer entwickelt.',
      items: [
        { title: '300+ Flugzeug-Datenbank', desc: 'Vorgeladene Stunden f\u00FCr 300+ Flugzeuge.' },
        { title: 'Sofort-Angebote', desc: 'Flugzeug w\u00E4hlen, Services ausw\u00E4hlen. Pr\u00E4zises Angebot in 60 Sekunden.' },
        { title: 'E-Mail & SMS Versand', desc: 'Senden Sie professionelle Angebote direkt an Ihre Kunden.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Kostenlos', desc: 'Vector risikofrei testen', cta: 'Kostenlos Starten', features: ['3 Angebote/Monat', '300+ Flugzeug-Datenbank', 'E-Mail-Angebote', 'Stripe-Zahlungen', '5% Plattformgeb\u00FChr'] },
        { name: 'Pro', desc: 'F\u00FCr Vollzeit-Detailer', cta: 'Pro W\u00E4hlen', features: ['Unbegrenzte Angebote', '300+ Flugzeug-Datenbank', 'E-Mail & SMS', 'SMS-Benachrichtigungen', 'Ohne Vector-Branding', 'Kalender', 'Priorit\u00E4ts-Support', '2% Plattformgeb\u00FChr'] },
        { name: 'Business', desc: 'F\u00FCr Teams', cta: 'Business W\u00E4hlen', features: ['Alles in Pro', 'Multi-User-Zugang', 'Lieferanten-Portal', 'API-Zugang', 'ROI-Analysen', 'SMS an Kunden', 'Dedizierter Support', '1% Plattformgeb\u00FChr'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        ...
        { q: 'Wie genau sind die Stunden?', a: 'Unsere Datenbank deckt 300+ Flugzeuge mit realen Daten ab.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'von Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Alle Rechte vorbehalten.', terms: 'AGB', privacy: 'Datenschutz', contact: 'Kontakt' },
  },
  ...
  it: {
    ...
    problems: [
      ...
      { title: '300+ Aeromobili, Le Tue Ore', desc: 'Ore predefinite per 300+ aeromobili. Usa le nostre, carica le tue o regola per lavoro.' },
    ...
    steps: [
      ...
      { title: 'Seleziona Aeromobile, Crea Preventivo', desc: 'Scegli tra 300+ aeromobili precaricati. Vector calcola il prezzo.' },
      { title: 'Invia al Cliente, Incassa', desc: 'Invia il preventivo via email o SMS. Il cliente paga online con un clic.' },
    ],
    features: {
      title: 'Tutto Ci\u00F2 di Cui Hai Bisogno',
      sub: 'Progettato specificamente per i detailer aeronautici.',
      items: [
        { title: 'Database di 300+ Aeromobili', desc: 'Ore precaricate per 300+ aeromobili.' },
        { title: 'Preventivo Istantaneo', desc: 'Seleziona aeromobile, scegli servizi. Preventivo preciso in 60 secondi.' },
        { title: 'Invio via Email e SMS', desc: 'Invia preventivi professionali direttamente ai clienti.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratuito', desc: 'Prova Vector senza rischi', cta: 'Inizia Gratis', features: ['3 preventivi/mese', 'Database 300+ aeromobili', 'Preventivi email', 'Pagamenti Stripe', '5% commissione'] },
        { name: 'Pro', desc: 'Per detailer a tempo pieno', cta: 'Vai Pro', features: ['Preventivi illimitati', 'Database 300+ aeromobili', 'Email e SMS', 'Avvisi SMS', 'Senza marchio Vector', 'Calendario', 'Supporto prioritario', '2% commissione'] },
        { name: 'Business', desc: 'Per team e grandi volumi', cta: 'Ottieni Business', features: ['Tutto in Pro', 'Accesso multiutente', 'Portale fornitori', 'Accesso API', 'Analisi ROI', 'SMS ai clienti', 'Supporto dedicato', '1% commissione'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        ...
        { q: 'Quanto sono precise le ore?', a: 'Il nostro database copre 300+ aeromobili con dati reali.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'di Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Tutti i diritti riservati.', terms: 'Termini', privacy: 'Privacy', contact: 'Contatto' },
  },
  ...
  nl: {
    ...
    problems: [
      ...
      { title: '300+ Vliegtuigen, Jouw Uren', desc: 'Standaarduren voor 300+ vliegtuigen. Gebruik de onze, upload de jouwe of pas aan per klus.' },
    ...
    steps: [
      ...
      { title: 'Selecteer Vliegtuig, Maak Offerte', desc: 'Kies uit 300+ voorgeladen vliegtuigen. Vector berekent de prijs.' },
      { title: 'Verstuur naar Klant, Word Betaald', desc: 'Stuur de offerte per e-mail of SMS. Je klant betaalt online met \u00E9\u00E9n klik.' },
    ],
    features: {
      title: 'Alles Wat Je Nodig Hebt',
      sub: 'Speciaal gebouwd voor vliegtuig-detailers.',
      items: [
        { title: '300+ Vliegtuig Database', desc: 'Voorgeladen uren voor 300+ vliegtuigen.' },
        { title: 'Directe Offertes', desc: 'Selecteer vliegtuig, kies services. Nauwkeurige offerte in 60 seconden.' },
        { title: 'E-mail & SMS Verzending', desc: 'Stuur professionele offertes direct naar je klanten.' },
    ...
    pricing: {
      ...
      tiers: [
        { name: 'Gratis', desc: 'Probeer Vector risicovrij', cta: 'Gratis Starten', features: ['3 offertes/maand', '300+ vliegtuig database', 'E-mail offertes', 'Stripe betalingen', '5% platformkosten'] },
        { name: 'Pro', desc: 'Voor fulltime detailers', cta: 'Ga Pro', features: ['Onbeperkte offertes', '300+ vliegtuig database', 'E-mail & SMS', 'SMS meldingen', 'Zonder Vector branding', 'Kalender', 'Prioriteit support', '2% platformkosten'] },
        { name: 'Business', desc: 'Voor teams', cta: 'Kies Business', features: ['Alles in Pro', 'Multi-user toegang', 'Leveranciersportaal', 'API toegang', 'ROI analyses', 'SMS naar klanten', 'Dedicated support', '1% platformkosten'] },
      ],
    },
    testimonials: {
    ...
    faqs: {
      ...
      items: [
        ...
        { q: 'Hoe nauwkeurig zijn de uren?', a: 'Onze database dekt 300+ vliegtuigen met echte data.' },
      ],
    },
    footerCta: {
    ...
    footer: { by: 'door Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. Alle rechten voorbehouden.', terms: 'Voorwaarden', privacy: 'Privacy', contact: 'Contact' },
  },
  ...
  ja: {
    ...
    steps: [
      ...
      { title: '\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u306B\u9001\u4FE1\u3001\u5165\u91D1', desc: '\u30E1\u30FC\u30EB\u307ESMS\u3067\u898B\u7A4D\u3092\u9001\u4FE1\u3002\u30EF\u30F3\u30AF\u30EA\u30C3\u30AF\u3067\u30AA\u30F3\u30E9\u30A4\u30F3\u6C7A\u6E08\u3002' },
    ],
    features: {
      ...
      items: [
        ...
        { title: '\u30E1\u30FC\u30EB\uFF06SMS\u9001\u4FE1', desc: '\u30D7\u30ED\u306E\u898B\u7A4D\u66F8\u3092\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8\u306B\u76F4\u63A5\u9001\u4FE1\u3002' },
    ...
    pricing: {
      ...
      tiers: [
        ...
        { name: 'Pro', desc: '\u30D5\u30EB\u30BF\u30A4\u30E0\u30C7\u30A3\u30C6\u30FC\u30E9\u30FC\u5411\u3051', cta: 'Pro\u306B\u3059\u308B', features: ['\u7121\u5236\u9650\u898B\u7A4D', '300\u6A5F\u4EE5\u4E0A\u306EDB', '\u30E1\u30FC\u30EB\uFF06SMS', 'SMS\u30A2\u30E9\u30FC\u30C8', 'Vector\u30D6\u30E9\u30F3\u30C9\u524A\u9664', '\u30AB\u30EC\u30F3\u30C0\u30FC', '\u512A\u5148\u30B5\u30DD\u30FC\u30C8', '2%\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u6599'] },
        { name: 'Business', desc: '\u30C1\u30FC\u30E0\u5411\u3051', cta: 'Business\u306B\u3059\u308B', features: ['Pro\u306E\u5168\u6A5F\u80FD', '\u30DE\u30EB\u30C1\u30E6\u30FC\u30B6\u30FC', '\u30D9\u30F3\u30C0\u30FC\u30DD\u30FC\u30BF\u30EB', 'API\u30A2\u30AF\u30BB\u30B9', 'ROI\u5206\u6790', '\u30AF\u30E9\u30A4\u30A2\u30F3\u30C8SMS', '\u5C02\u4EFB\u30B5\u30DD\u30FC\u30C8', '1%\u30D7\u30E9\u30C3\u30C8\u30D5\u30A9\u30FC\u30E0\u6599'] },
      ],
    },
    testimonials: {
      title: '\u30C7\u30A3\u30C6\u30FC\u30E9\u30FC\u306E\u58F0',
    ...
    footer: { by: 'by Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. All rights reserved.', terms: '\u5229\u7528\u898F\u7D04', privacy: '\u30D7\u30E9\u30A4\u30D0\u30B7\u30FC', contact: '\u304A\u554F\u3044\u5408\u308F\u305B' },
  },
  ...
  zh: {
    ...
    problems: [
      ...
      { title: '300+\u98DE\u673A\uFF0C\u60A8\u7684\u65F6\u95F4', desc: '300+\u98DE\u673A\u7684\u9ED8\u8BA4\u5DE5\u65F6\u3002\u4F7F\u7528\u6211\u4EEC\u7684\u6570\u636E\u3001\u4E0A\u4F20\u60A8\u7684\u6570\u636E\u6216\u6309\u5DE5\u4F5C\u8C03\u6574\u3002' },
      { title: '\u60A8\u7684\u8D39\u7387 \u00D7 \u60A8\u7684\u5DE5\u65F6', desc: '\u8BBE\u7F6E\u5C0F\u65F6\u8D39\u7387\u3002\u9009\u62E9\u98DE\u673A\u3002\u8C03\u6574\u5DE5\u65F6\u3002Vector\u8BA1\u7B97\u4E00\u5207\u3002' },
    ],
    howItWorks: { title: '\u5982\u4F55\u8FD0\u4F5C', sub: '\u4ECE\u8BBE\u7F6E\u5230\u6536\u6B3E\u2014\u2014\u4E09\u4E2A\u7B80\u5355\u6B65\u9AA4\u3002' },
    steps: [
      { title: '\u6DFB\u52A0\u670D\u52A1\u548C\u8D39\u7387', desc: '\u8BBE\u7F6E\u670D\u52A1\u83DC\u5355\u548C\u5C0F\u65F6\u8D39\u7387\u3002' },
      { title: '\u9009\u62E9\u98DE\u673A\uFF0C\u521B\u5EFA\u62A5\u4EF7', desc: '\u4ECE300+\u9884\u52A0\u8F7D\u98DE\u673A\u4E2D\u9009\u62E9\u3002Vector\u8BA1\u7B97\u4EF7\u683C\u3002' },
      { title: '\u53D1\u9001\u7ED9\u5BA2\u6237\uFF0C\u6536\u6B3E', desc: '\u901A\u8FC7\u90AE\u4EF6\u6216\u77ED\u4FE1\u53D1\u9001\u62A5\u4EF7\u3002\u5BA2\u6237\u4E00\u952E\u5728\u7EBF\u652F\u4ED8\u3002' },
    ],
    features: {
      title: '\u60A8\u9700\u8981\u7684\u4E00\u5207',
      sub: '\u4E13\u4E3A\u98DE\u673A\u7F8E\u5BB9\u5E08\u8BBE\u8BA1\u3002',
      items: [
        { title: '300+\u98DE\u673A\u6570\u636E\u5E93', desc: '300+\u98DE\u673A\u7684\u9884\u8BBE\u5DE5\u65F6\u3002' },
        { title: '\u5373\u65F6\u62A5\u4EF7', desc: '\u9009\u62E9\u98DE\u673A\uFF0C\u9009\u62E9\u670D\u52A1\u300260\u79D2\u7CBE\u786E\u62A5\u4EF7\u3002' },
        { title: '\u90AE\u4EF6\u548C\u77ED\u4FE1\u53D1\u9001', desc: '\u76F4\u63A5\u5411\u5BA2\u6237\u53D1\u9001\u4E13\u4E1A\u62A5\u4EF7\u3002' },
    ...
    pricing: {
      ...
      tiers: [
        { name: '\u514D\u8D39', desc: '\u65E0\u98CE\u9669\u8BD5\u7528Vector', cta: '\u514D\u8D39\u5F00\u59CB', features: ['3\u4E2A\u62A5\u4EF7/\u6708', '300+\u98DE\u673A\u6570\u636E\u5E93', '\u90AE\u4EF6\u62A5\u4EF7', 'Stripe\u652F\u4ED8', '5%\u5E73\u53F0\u8D39'] },
        { name: 'Pro', desc: '\u9002\u5408\u5168\u804C\u7F8E\u5BB9\u5E08', cta: '\u5347\u7EA7Pro', features: ['\u65E0\u9650\u62A5\u4EF7', '300+\u98DE\u673A\u6570\u636E\u5E93', '\u90AE\u4EF6\u548C\u77ED\u4FE1', '\u77ED\u4FE1\u63D0\u9192', '\u53BB\u9664Vector\u54C1\u724C', '\u65E5\u5386', '\u4F18\u5148\u652F\u6301', '2%\u5E73\u53F0\u8D39'] },
        { name: 'Business', desc: '\u9002\u5408\u56E2\u961F', cta: '\u83B7\u53D6Business', features: ['Pro\u6240\u6709\u529F\u80FD', '\u591A\u7528\u6237\u8BBF\u95EE', '\u4F9B\u5E94\u5546\u95E8\u6237', 'API\u8BBF\u95EE', 'ROI\u5206\u6790', '\u5BA2\u6237\u77ED\u4FE1', '\u4E13\u5C5E\u652F\u6301', '1%\u5E73\u53F0\u8D39'] },
      ],
    },
    testimonials: {
      title: '\u7F8E\u5BB9\u5E08\u7684\u8BC4\u4EF7',
    ...
    faqs: {
      ...
      items: [
        ...
        { q: '\u5DE5\u65F6\u51C6\u786E\u5417\uFF1F', a: '\u6211\u4EEC\u7684\u6570\u636E\u5E93\u8986\u76D6300+\u98DE\u673A\uFF0C\u57FA\u4E8E\u5B9E\u9645\u6570\u636E\u3002\u60A8\u53EF\u4EE5\u968F\u65F6\u8C03\u6574\u3002' },
      ],
    },
    footerCta: {
      title: '\u51C6\u5907\u597D\u53D1\u5C55\u4E1A\u52A1\u4E86\u5417\uFF1F',
    ...
    footer: { by: 'by Aircraft Detailing 101', copy: '\u00A9 2025 Vector Aviation Software. \u4FDD\u7559\u6240\u6709\u6743\u5229\u3002', terms: '\u670D\u52A1\u6761\u6B3E', privacy: '\u9690\u79C1\u653F\u7B56', contact: '\u8054\u7CFB\u6211\u4EEC' },
  },
};
