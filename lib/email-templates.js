...
function emailWrapper(content, { headerBg = BRAND_COLOR, headerText = '', companyName = '', unsubscribeEmail = '' } = {}) {
  ...
  const brandName = companyName
    ? `<span style="color: #ffffff; font-size: 28px; font-weight: 700; letter-spacing: -0.5px;">&#9992;&#65039; ${companyName}</span>`
...
export function quoteSentTemplate({ quote, detailer, language }) {
  ...
  const i18n = {
    en: { greeting: 'Hi', quoteReady: 'has prepared a quote for your aircraft detailing service.', viewQuotePay: 'View Quote &amp; Pay', questions: 'Questions? Reply to this email or contact', directly: 'directly.', aircraftLabel: 'Aircraft', airportLabel: 'Airport', servicesLabel: 'Services', validUntilLabel: 'Valid Until', totalLabel: 'Total', noteLabel: 'Note', subject: 'Your Quote from', subjectSuffix: 'is Ready!', header: 'Your Quote is Ready', previewText: 'Your aircraft detailing quote is ready to view and pay.' },
    es: { greeting: 'Hola', quoteReady: 'ha preparado una cotización para su servicio de detallado de aeronaves.', viewQuotePay: 'Ver Cotización y Pagar', questions: '¿Preguntas? Responda a este correo o contacte a', directly: 'directamente.', aircraftLabel: 'Aeronave', airportLabel: 'Aeropuerto', servicesLabel: 'Servicios', validUntilLabel: 'Válido Hasta', totalLabel: 'Total', noteLabel: 'Nota', subject: 'Su Cotización de', subjectSuffix: 'Está Lista!', header: 'Su Cotización Está Lista', previewText: 'Su cotización de detallado de aeronaves está lista para ver y pagar.' },
    fr: { greeting: 'Bonjour', quoteReady: 'a préparé un devis pour votre service de nettoyage d\'aéronef.', viewQuotePay: 'Voir le Devis et Payer', questions: 'Des questions ? Répondez à cet e-mail ou contactez', directly: 'directement.', aircraftLabel: 'Aéronef', airportLabel: 'Aéroport', servicesLabel: 'Services', validUntilLabel: 'Valide Jusqu\'au', totalLabel: 'Total', noteLabel: 'Note', subject: 'Votre Devis de', subjectSuffix: 'est Prêt!', header: 'Votre Devis est Prêt', previewText: 'Votre devis de nettoyage d\'aéronef est prêt à consulter et payer.' },
    pt: { greeting: 'Olá', quoteReady: 'preparou um orçamento para o serviço de detalhamento da sua aeronave.', viewQuotePay: 'Ver Orçamento e Pagar', questions: 'Dúvidas? Responda este e-mail ou entre em contato com', directly: 'diretamente.', aircraftLabel: 'Aeronave', airportLabel: 'Aeroporto', servicesLabel: 'Serviços', validUntilLabel: 'Válido Até', totalLabel: 'Total', noteLabel: 'Nota', subject: 'Seu Orçamento de', subjectSuffix: 'Está Pronto!', header: 'Seu Orçamento Está Pronto', previewText: 'Seu orçamento de detalhamento de aeronave está pronto para visualizar e pagar.' },
    de: { greeting: 'Hallo', quoteReady: 'hat ein Angebot für Ihren Flugzeugaufbereitungsservice erstellt.', viewQuotePay: 'Angebot Ansehen &amp; Bezahlen', questions: 'Fragen? Antworten Sie auf diese E-Mail oder kontaktieren Sie', directly: 'direkt.', aircraftLabel: 'Flugzeug', airportLabel: 'Flughafen', servicesLabel: 'Dienstleistungen', validUntilLabel: 'Gültig Bis', totalLabel: 'Gesamt', noteLabel: 'Hinweis', subject: 'Ihr Angebot von', subjectSuffix: 'ist Bereit!', header: 'Ihr Angebot ist Bereit', previewText: 'Ihr Flugzeugaufbereitungs-Angebot ist bereit zur Ansicht und Bezahlung.' },
  };
...
${L.questions} ${companyName} ${L.directly}
  ...
  return {
    subject: `✈️ ${L.subject} ${companyName} ${L.subjectSuffix}`,
