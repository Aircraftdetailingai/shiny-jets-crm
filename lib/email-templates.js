...
export function compInviteTemplate({ email }) {
  ...
  const content = `
    ...
    <p style="font-size:15px;line-height:1.6;margin:0 0 16px;color:#1a1a1a;">
      Setting you up with a free year of the Shiny Jets CRM, Pro plan &mdash; comped because you took the course.
    </p>
    ...
    <div style="background:#f0f7fb;border:1px solid #cfe4f0;border-radius:8px;padding:16px 18px;margin:20px 0;">
      ...
      <p style="font-size:12px;color:#555;margin:10px 0 0;">That's how the Pro comp applies automatically. Sign in with Google works too &mdash; just make sure the Google account uses this address.</p>
    </div>

    <div style="text-align:center;margin:24px 0;">
      <a href="${signupUrl}" style="display:inline-block;padding:14px 28px;background:#007CB1;color:#fff;text-decoration:none;border-radius:8px;font-weight:600;font-size:15px;">Sign up &mdash; Pro applies automatically</a>
    </div>

    <p style="font-size:14px;line-height:1.6;margin:20px 0 8px;color:#1a1a1a;font-weight:600;">What you get on Pro:</p>
    <ul style="font-size:14px;line-height:1.7;margin:0 0 18px;padding-left:20px;color:#1a1a1a;">
      <li>Up to 3 primary + 5 secondary airports</li>
      <li>Full CRM, customer database, invoicing, quoting</li>
      <li>Job dispatch + crew management</li>
      <li>Listed on directory.shinyjets.com</li>
    </ul>
    ...
    <p style="font-size:14px;line-height:1.6;margin:0;color:#1a1a1a;">&mdash; Brett<br/>shinyjets.com</p>
  `;

  const text = `Hey,

Setting you up with a free year of the Shiny Jets CRM, Pro plan — comped because you took the course.
...
What you get on Pro:
- Up to 3 primary + 5 secondary airports
- Full CRM, customer database, invoicing, quoting
- Job dispatch + crew management
- Listed on directory.shinyjets.com
...
shinyjets.com`;
  ...
  return {
    subject: 'Your free year of Shiny Jets CRM is ready',
    html: emailWrapper(content, { headerBg: '#0D1B2A', headerText: 'Your free Pro year' }),
    text,
  };
}
