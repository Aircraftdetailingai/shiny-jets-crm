...
export const SHOPIFY_PLANS = {
  pro: {
    shopifyUrl: 'https://shinyjets.com/products/aircraft-detailing-crm-pro',
    stripePriceId: 'price_1TGnugCcQQZWc7n0Ge8tsTQC',
    price: 79,
    name: 'Shiny Jets CRM Pro'
  },
  business: {
    shopifyUrl: 'https://shinyjets.com/products/aircraft-detailing-crm-business',
    stripePriceId: 'price_1TGnvHCcQQZWc7n0uEDAqRvb',
    price: 149,
    name: 'Shiny Jets CRM Business'
  },
  enterprise: {
    shopifyUrl: 'https://shinyjets.com/products/aircraft-detailing-crm-enterprise',
