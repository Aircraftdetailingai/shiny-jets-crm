    ...
    <div className="min-h-screen bg-[var(--brand-bg,#0A0E17)]" style={brandFontBody ? { fontFamily: brandFontBody } : undefined}>
      ...
      <div className="max-w-[640px] mx-auto px-6 py-8">
        ...
        <div className="text-center mt-10 pb-8">
          <p className="text-[var(--brand-text-secondary,#8A9BB0)]/40 text-[10px] tracking-[0.3em] uppercase">Powered by <a href="https://vectorav.ai" className="hover:text-[var(--brand-primary,#C9A84C)] transition-colors">Vector Aviation</a></p>
        </div>
      </div>
    </div>
  );
