# Air Tractor AT-502/502B/504

| Field | Value |
|---|---|
| Make | Air Tractor |
| Model | AT-502/502B/504 |
| Catalog seats (CRM) | 1 |
...
Follow `type-class/agricultural.md` for baseline wash/polish/boot/antenna discipline when model-specific POH cleaning text is not loaded.
