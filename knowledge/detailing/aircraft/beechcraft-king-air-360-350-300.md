# Beechcraft King Air 360/350/300

| Field | Value |
|---|---|
| Make | Beechcraft |
| Model | King Air 360/350/300 |
| Catalog seats (CRM) | 5 |
...
No dedicated free cleaning PDF in Aviation_Manuals pack for King Air. Use `type-class/turboprop.md` + Baron/Bonanza wash **discipline** (no HP wash, tape probes, mild soap) as interim shop practice, then confirm against the specific King Air AMM Ch.12. Exhaust soot on nacelles/belly is normal — use aviation degreasers compatible with paint.
...
Follow `type-class/turboprop.md` for baseline wash/polish/boot/antenna discipline when model-specific POH cleaning text is not loaded.
